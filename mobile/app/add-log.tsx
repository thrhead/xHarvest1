...
export default function AddLogScreen() {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      await createLog({
        ...
        phiDays: phi != null && !isNaN(phi) && phi > 0 ? phi : undefined,
        unitCostTry: cost != null && !isNaN(cost) && cost >= 0 ? cost : undefined,
        totalCostTry:
          cost != null && !isNaN(cost) && cost >= 0 ? cost * q : undefined,
      });
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {inputType === 'pesticide' && (
        <>
          <Text style={styles.label}>PHI / hasat bekleme (gün)</Text>
          <TextInput
            style={styles.input}
            placeholder="Örn. 14"
      ...
      <Text style={styles.label}>Birim maliyet (₺, opsiyonel)</Text>
      <TextInput
        style={styles.input}
        placeholder="Örn. 120"
