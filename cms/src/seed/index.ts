...
const CROPS_TEMPLATES = [
  ...
  },
  {
    ...
    stages: [
      ...
      {
        name: 'Flowering & Bunch Development',
        nameTr: 'Çiçeklenme ve Salkım Gelişimi',
        dayOffset: 30,
        durationDays: 60,
        tasks: [
          { type: 'spraying', title: 'Powdery mildew protection', titleTr: 'Külleme ve Mildiyö İlaçlaması', description: 'Nemli havalarda salkım koruma ilaçlaması yapılır.' }
        ]
      },
      {
        name: 'Harvest',
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        durationDays: 35,
        tasks: [
          { type: 'irrigation', title: 'Regular drip irrigation', titleTr: 'Damla Sulama', description: 'Meyve döneminde düzenli sulama çok önemlidir.' }
        ]
      },
      {
        name: 'Harvest',
