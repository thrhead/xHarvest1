          ...
          {!isDrawing ? (
            <div className="space-y-4">
              <p className="text-xs text-slate-600 leading-relaxed">
                Harita üzerinde tarlanızın sınırlarını işaretlemek ve alanını hesaplamak için çizim modunu başlatın.
              </p>

              <button
                onClick={handleStartDrawing}
                className="w-full py-2.5 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-medium text-sm rounded-xl shadow-sm transition flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
                Yeni Tarla Çizimi Başlat
              </button>
            </div>
          ) : (
